...
import com.devexpress.logify.alert.android.TestLogifyAlert;
...
public class AndroidCompositeInfoCollectorTests extends CollectorTestsBase {
    ...
    public void testAllFieldsArePresent() throws Exception {
        ...
        assertNotNull(report.get("device"));
